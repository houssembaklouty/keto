...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form  action="{{url('payment')}}"  data-cc-on-file="false" data-stripe-publishable-key="pk_test_22NlSvV3LNqYsUaVPTU51RMh00mxrpYw0J" name="frmStripe" id="frmstripe" method="post">
                {{ csrf_field() }}
                <div class="row">
